...
class SleepState:
    ...
    def draw(boy):
        if boy.dir == 1:
            boy.image.clip_composite_draw(100, 300, 100, 100, 3.141592 / 2, '', boy.x - 25, boy.y - 25, 100, 100)
            ...
            boy.image.clip_composite_draw(100, 200, 100, 100, -3.141592 / 2, '', boy.x + 25, boy.y - 25, 100, 100)
            if boy.round_timer < 1:
                boy.ghost_image.opacify(0.1 * random.randint(1, 9))
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - 60, self.y + 50, '(Time: %3.2f)' % get_time(), (255, 0, 0))
