...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 60, self.y - self.bg.window_bottom + 50,
                       '(ballcount: %d)' % (self.count), (255, 255, 0))
    ...
    def get_bb(self):
        return self.x - 50 - int(self.bg.window_left),\
               self.y - 50 - int(self.bg.window_bottom),\
               self.x + 50 - int(( self.bg.window_left )),\
               self.y + 50 - int(( self.bg.window_bottom ))
