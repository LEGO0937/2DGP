...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp(0 + (boy.y / 5), boy.x, boy.bg.w - (boy.y / 5))
        boy.y = clamp(0 + 70, boy.y, boy.bg.h - 40)
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 60, self.y - self.bg.window_bottom + 50, '(%5d, %5d)' % (self.x, self.y),
                       (255, 255, 0))
